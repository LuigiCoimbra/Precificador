...
//console.log(amazonCount[1])
var a = 0
//console.log (productArray[1][2])
const SavaPrice = async function () {
      ...
      <dataSet rootEntity="AD_LOGALTERPRECO">
          ...
          <dataRow>
              <localFields>
                ...
                <CODTAB>${amazonCount[1][a][1]}</CODTAB>
                <CODPROD>${amazonCount[1][a][2]}</CODPROD>
                <PRECOANT>${amazonCount[1][a][4]}</PRECOANT>
                <PRECO>${amazonCount[1][a][3]}</PRECO>
